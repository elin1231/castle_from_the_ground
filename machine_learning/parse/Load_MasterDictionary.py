...
def load_masterdictionary(file_path, print_flag=False, f_log=None, get_other=False):
    ...
    if print_flag:
        ...
        print(
            "  {0:,} words loaded in master_dictionary.".format(len(_master_dictionary))
            + "\n"
        )
...
if __name__ == "__main__":
    ...
    md = (
        r"D:\GD\Research\Natural_Language_Processing\Dictionaries\Master\\"
